...
from app.routers import bank, users_account, users_deals
...
app = FastAPI(title='Bank Service API')
...
app.include_router(users_account.router)
app.include_router(users_account.router)
app.include_router(users_deals.router)
